...
import com.qianlong.qlttms.dao.jdbc.JdbcDao;
import com.qianlong.qlttms.exception.BusinessException;
import com.qianlong.qlttms.utils.MyBeanUtils;
...
public abstract class BaseCommonDao<T, PK extends Serializable> implements
		IBaseCommonDao {
	/**
	 * 初始化Log4j的一个实例
	 */
