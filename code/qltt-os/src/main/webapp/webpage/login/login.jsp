...
<body>
    ...
    <div id="versionBar">
        ...
        <div class="copyright">&copy; 版权所有 <span class="tip"><a href="http://www.cdqianlong.com" title="成都乾隆" target="_blank">钱龙推推微信管理平台</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)   &nbsp;&nbsp;&nbsp;技术支持: 成都乾隆</span></div>    	
    </div>
    <!-- Link JScript-->
