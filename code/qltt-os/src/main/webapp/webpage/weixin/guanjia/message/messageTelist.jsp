...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="messageList" checkbox="false" fitColumns="false" title="消息模板管理" actionUrl="messagetemplate.do?datagrid" idField="templateId" fit="true" sortOrder="desc">
