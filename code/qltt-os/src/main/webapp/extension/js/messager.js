(function ($) {
    ...
    $.fn.confirm = function(options,fn){
        ...
        html += '<div class="animated confirm" style="position: fixed;top: 0;bottom: 0;left: 0;right: 0;display: block;z-index: 99999;color: #666;background-color:rgba(0,0,0,0);font-size:1.4rem;">'
             ...
             +          '<div class="confirm-head" style="height: 40px;line-height: 40px;text-align: center;border-bottom:1px solid #eee;padding:0 10px;">消息提示<img src="../../extension/images/confirm.png"  style="width: 18px;margin-top: 10px;float: right;"  alt="" /></div>'
        ...
        $('.confirm-btn-no, .confirm-head').tap(function(e){
            $('.confirm').removeClass('fadeIn').addClass('fadeOut').css('display','none').remove();
            e.stopPropagation();
        })
